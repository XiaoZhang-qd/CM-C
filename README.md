...
> <s>**注意：** 由于msys的特殊性，如果你用msys，输入完IP/域名和PORT后，需要再输入exit退出cmd终端，有知道怎么解决的请到[issue](https://github.com/XiaoZhang-qd/cm-c/issues/1)给作者，谢谢。</s>
...
4. 受害机上线后，受控端会发来信息如(注意：如果使用CM-C-Server的话当受控端链接成功后的提示信息为``[*] Client[设备ID] connected (Total online: 在线设备数量)``：
````
